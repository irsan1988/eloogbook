...
$map=xray_multi_checkbox_map();
[$titleLine1,$titleLine2]=xray_multi_header_lines((string)($session['code']??'XRAY-MULTI-BAGASI'));
  ...
  <form method="post" action="<?=e($action)?>">
    ...
    <div class="xray-sheet-shell" data-xray-shell>
      <div class="xray-sheet">
        <img src="<?=e(url('public/assets/templates/xray-multi-view-template.png'))?>" alt="Template checklist X-Ray Multi View">
        <div class="xray-template-title"><div class="line1"><?=e($titleLine1)?></div><div><?=e(preg_replace('/\s+MULTI VIEW$/','',$titleLine2))?> <span class="mv">MULTI VIEW</span></div></div>
        ...
        <?php if($sigField):?>
          <div class="xray-inline-signature" data-signature-wrap title="Tanda tangan Personel Pengamanan Penerbangan 1">
            <canvas id="<?=e($sigCanvasId)?>" width="700" height="190" data-signature-pad aria-label="Area tanda tangan Personel Pengamanan Penerbangan 1"></canvas>
          </div>
