...
?>
<div class="page">
  <img class="template" src="<?=e(url('public/assets/templates/xray-multi-view-template.png'))?>" alt="Checklist X-Ray Multi View">
  <div class="template-title">
    <div class="line1"><?=e($titleLine1)?></div>
    <div><?=e(preg_replace('/\s+MULTI VIEW$/','',$titleLine2))?> <span class="mv">MULTI VIEW</span></div>
  </div>
